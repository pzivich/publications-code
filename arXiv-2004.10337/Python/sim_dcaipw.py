#####################################################################################
# Simulations for double cross-fit AIPW:
...
from estimators import DoubleCrossfitAIPTW
...
file_path_to_save_results = "dcaipw_results"+str(setup)+".csv"  # file path to save all result output
n_diff_splits = 100  # number of different splits to use
