...
from beowulf import load_uniform_diet, load_random_diet, truth_values
...
# NetworkTMLE models
gin_model = "B_30 + G:E + E_mean"
gsn_model = "diet + B_30 + G:E + E_mean"
qn_model = "diet + diet_t3 + B + G + E + E_sum + B_mean_dist"
gs_dist = "threshold"
gs_measure = "t3"
