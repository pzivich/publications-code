...
from beowulf.dgm import vaccine_dgm_truth
from beowulf import load_uniform_vaccine, load_random_vaccine, simulation_setup

n_sims_truth = 10000
np.random.seed(30220109)
...
for t in treat_plan:
    ...
    for i in range(n_sims_truth):
        ans.append(vaccine_dgm_truth(network=G, pr_a=t, shift=shift, restricted=restrict))
