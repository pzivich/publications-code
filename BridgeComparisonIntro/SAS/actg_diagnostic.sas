...
%diagnostic_plot(data=dat, treatment=art, outcome=delta, time=t, sample=study, censor=censor, 
                 sample_model= , 
...
%diagnostic_test(data=dat, treatment=art, outcome=delta, time=t, sample=study, censor=censor, 
                 sample_model= , 
                 censor_model=male black idu age age_rs0 age_rs1 age_rs2 karnof_cat study, 
                 class_vars=karnof_cat, bootstrap_n=1000);
RUN; 
/*Area: 32.50; 95%CI: 24.46, 40.54; P-value = 0.0*/
...
%diagnostic_test(data=dat, treatment=art, outcome=delta, time=t, sample=study, censor=censor, 
                 ...
                 class_vars=karnof_cat, bootstrap_n=1000);
RUN; 
/*Area: 30.05; 95%CI: 20.70, 39.40; P-value = 0.0*/
...
%diagnostic_test(data=dat, treatment=art, outcome=delta, time=t, sample=study, censor=censor, 
                 ...
                 class_vars=karnof_cat, bootstrap_n=1000);
RUN; 
/*Area: 36.37; 95%CI: 28.19, 44.55; P-value = 0.0*/
...
/*Running permutation test*/
%diagnostic_test(data=rdat, treatment=art, outcome=delta, time=t, sample=study, censor=censor, 
                 sample_model=male black idu age age_rs0 age_rs1 age_rs2 karnof_cat, 
                 censor_model=male black idu age age_rs0 age_rs1 age_rs2 karnof_cat study, 
                 class_vars=karnof_cat, bootstrap_n=1000);
RUN; 
/*Area: 7.94; 95%CI: -2.73, 18.61; P-value = 0.14*/
